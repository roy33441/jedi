...
func (service *MissingReasonService) AddMissingReason(missingReason models.MissingReason) (*models.MissingReason, error) {
	return service.missingReasonRepository.Add(missingReason)
}

func (service *MissingReasonService) DeleteMissingReason(missingReasonId string) (*models.MissingReason, error) {
	return service.missingReasonRepository.Delete(missingReasonId)
}

func (service *MissingReasonService) UpdateMissingReason(missingReason models.MissingReason) (*models.MissingReason, error) {
